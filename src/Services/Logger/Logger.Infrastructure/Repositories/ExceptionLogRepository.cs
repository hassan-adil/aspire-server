...
public class ExceptionLogRepository(LoggerDbContext dbContext, IUnitOfWork unitOfWork) : IExceptionLogRepository, IScopedDependency
{
    public async Task<List<ExceptionLog>> ReadLogs(Guid? tenantId = null, string? serviceName = null, string? httpMethod = null, int? statusCode = null, Guid? userId = null, DateTimeOffset? startDate = null, DateTimeOffset? endDate = null)
    {
    ...
    public async Task<ExceptionLog> InsertLog(ExceptionLog log)
    {
